...
local characterBits = if #characters > 0 then math.ceil(math.log(#characters + 1, 2)) else 1
...
local staticIndices1 = {}
local statics1 = require(script.Static1)
for index, static in statics1 do staticIndices1[static] = index end
types.Static1 = ("Static1" :: any) :: any
reads.Static1 = function() return statics1[ReadU8()] end
writes.Static1 = function(value: any) Allocate(1) WriteU8(staticIndices1[value] or 0) end

local staticIndices2 = {}
local statics2 = require(script.Static2)
for index, static in statics2 do staticIndices2[static] = index end
types.Static2 = ("Static2" :: any) :: any
reads.Static2 = function() return statics2[ReadU8()] end
writes.Static2 = function(value: any) Allocate(1) WriteU8(staticIndices2[value] or 0) end

local staticIndices3 = {}
local statics3 = require(script.Static3)
for index, static in statics3 do staticIndices3[static] = index end
types.Static3 = ("Static3" :: any) :: any
reads.Static3 = function() return statics3[ReadU8()] end
writes.Static3 = function(value: any) Allocate(1) WriteU8(staticIndices3[value] or 0) end
