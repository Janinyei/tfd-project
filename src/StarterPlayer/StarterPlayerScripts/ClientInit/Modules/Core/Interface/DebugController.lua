...
function DebugController:_render()
	...
	line("Mouse captured [T]", Flight:IsMouseLocked())
	...
	line("Predicted noclips", probe.PredictedParts)
	line("Clear passes (no carve)", probe.ClearPasses)
	line("Debris hits skipped", probe.DebrisSkips)
	line("Last hit", probe.LastHitName .. " / " .. probe.LastHitGroup)
